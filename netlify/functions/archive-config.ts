...
export const handler: Handler = async () => {
  ...
  try {
    const [seasons, bosses, characters, lightcones, articles] = await Promise.all([
      ...
      sql`select id, season_id as "seasonId", mode, name, variant_name as "variantName", subtitle, hp, speed, toughness, weakness, resist, clears, mechanic, stage_buffs as "stageBuffs", banner_tone as "bannerTone" from stages`,
