      ...
      >
        ...
        >
          <article class="stat-panel">
            ...
            <ol>
              <li
                v-for="entry in stats.characterUsage.slice(0, 8)"
                :key="entry.unit.id"
              >
          ...
          <article class="stat-panel">
            ...
            <ol>
              <li
                v-for="entry in stats.lightconeUsage.slice(0, 8)"
                :key="entry.unit.id"
              >
                <span>{{ entry.unit.name }}</span>
                <b>{{ entry.rate }}%</b>
          ...
          <article class="stat-panel wide">
            ...
            <ol>
              <li
                v-for="combo in stats.teamCombos.slice(0, 6)"
                :key="combo.name"
              >
          ...
          <article class="stat-panel">
            ...
            <ol>
              <li
                v-for="bucket in stats.costBuckets"
                :key="bucket.label"
              >
