...
export const changelogEntries: ChangelogEntry[] = [
	...
	},
	{
		...
		title: "投稿自助管理：改、藏、删",
		items: [
			{tag: "feature", text: "「我的投稿」里已通过的记录可以「编辑并重新提交」：改动先进审核队列，管理员通过之前档案里仍展示上一次通过的记录，通过后原地更新那条记录、不会多出第二条"},
			{tag: "feature", text: "被驳回的记录也可以编辑并重新提交（就地重提同一条，不用重填四槽角色与光锥），并且新增「删除记录」——直接从数据库移除、不经审核、删后查不到，点击后要在卡片内再确认一次"},
			{tag: "feature", text: "已驳回与已撤回的记录可以「隐藏展示」：隐藏状态存在服务端，换浏览器或设备同样不再展示，页顶「已隐藏 N 条 · 查看」可以展开并随时取消隐藏"},
			{tag: "fix", text: "撤回一条记录不再连带撤掉同一凭证下的其它公开记录"},
			{tag: "fix", text: "「我的投稿」底部「已通过的投稿」不再混入已驳回与已撤回的记录"},
		],
	},
	{
		version: "0.8.1",
		...
		title: "配队预设扩容",
		items: [
			{tag: "improve", text: "投稿表单的配队预设上限从 3 套提升到 10 套，本机已存的预设不受影响，载入与「另存为」的提示都按新上限显示"},
		],
	},
	{
		version: "0.8.0",
